...
TPWUserLogin = "_________________"  # Admin Login
TPWUserPassword = "______________"   # Admin Password
TPWAPIURL = "____________________"
TPWSubscriberID = "______________"
TPWModuleID = "__________________"
